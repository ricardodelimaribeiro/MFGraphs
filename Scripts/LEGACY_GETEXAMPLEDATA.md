...
Target replacement path is scenario-based construction (for example,
`getExampleScenario[...]`, `gridScenario[...]`, or `makeScenario[...]`) with
input-defined boundaries/switching costs.
